...
export function DispatcherPanel({ analysis, booking, onCreate, onStatus, loading }: { analysis: Analysis; booking: Booking | null; onCreate: () => void; onStatus: (status: Booking["status"]) => void; loading: boolean }) {
  return <aside className="dispatcher-panel">
    <div className="panel-top"><div><span className="eyebrow">DISPATCH CONSOLE</span><h2>Ready for a decision</h2></div><span className="live-dot">Live</span></div>
